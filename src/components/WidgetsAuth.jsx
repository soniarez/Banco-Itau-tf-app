...
const WidgetsAuth = () => {
    ...
    return (
        <div className={result?'bg-[#EC7000] w-96 flex flex-col rounded-2xl m-6 shadow-lg':'bg-[#FFFFFF] w-96 flex flex-col rounded-2xl m-6 shadow-lg border-[#EC7000] border'}>
